...
declare module 'bootstrap/dist/js/bootstrap.bundle' {
    ...
    type PlacementFunction = () => void;

    type TitleFunction = () => void;

    type OffsetFunction = () => void;
    ...
    declare namespace Tooltip {
        ...
        interface Options {
             ...
             * @default 'top'
             */
            placement: 'auto' | 'top' | 'bottom' | 'left' | 'right' | PlacementFunction;
             ...
             * @default ''
             */
            title: string | Element | TitleFunction;
             ...
             * @default 0
             */
            offset: number | string | OffsetFunction;
         ...
         * with a DOM element
         */
        function getInstance(element: Element): Tooltip;
    }
